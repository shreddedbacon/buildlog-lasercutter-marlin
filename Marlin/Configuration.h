...
#define HOMING_FEEDRATE {50*60, 50*60, 4*60, 0}  // set the homing speeds (mm/min) (3000, 3000, 240)
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {80,80,9600}  // X,Y,Z 
